            ...
            <div className="col-lg-9 col-md-8 col-sm-12">
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-6 p-3">
                  ...
                  <ul>
                    <li><a href="https://github.com/octopuswaterfall/">v1.2 - Profile Page</a></li>
                    <li><a href="https://github.com/octopuswaterfall/">v1.2 - Responsive Design on Beranda Page</a></li>
                  </ul>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-6 col-6 p-3">
                  ...
                  <ul>
                    <li className="d-inline m-1">
                      <a href="https://github.com/adamcanray/">
                ...
                <div className="col-lg-4 col-md-6 col-sm-6 col-6 p-3">
                  ...
                  <ul>
                    <li><a href="https://www.mindmeister.com/1376641656/">Mindmeister</a></li>
                    <li><a href="https://github.com/adamcanray/">GitHub Project</a></li>
                    <li><a href="https://github.com/adamcanray/octopus-waterfall">GitHub Repository</a></li>
                  </ul>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-6 col-6 p-3">
                  ...
                  <ul>
                    <li className="text-light">
                      ...
                      <a href="https://developer.octopuswaterfall.web.app/">developer.octopuswaterfall.web.app</a></li>
                    <li className="text-light">
                      <small>or Pull Request</small><br/>
                      <a href="https://github.com/adamcanray/">GitHub Repository</a>
                    </li>
                  </ul>
                </div>
              </div>
...
const BotFooter = () => {
  return (
    <div className="bot-footer text-center text-light">
      <small>&copy;2019 Built With &#10084; by: <a href="https://instagram.com/adamcanray">Muhammad Adam Canrayneldy</a></small>
    </div>
  )
}
